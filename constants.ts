...
I then took my thesis to Tokyo, Japan, to present at the International Conference on Intelligent Science and Sustainable Development (ISASD). This was rare for a working student; the other two attendees only presented posters, but I cared deeply about my academic achievement. In July 2024, I flew to the Tokyo Institute of Technology and gave a full English presentation—a risk, as I had never done so before—but it received unanimous praise. My paper later won an "Honorable Mention" from the Institution of Engineering and Technology, Taipei Local Network in October 2024. It was subsequently published in the International Journal of Human-Computer Interaction on December 31, 2025, with the revised title From Content to Conversation: Explaining Adoption of On-Device Generative AI Tour Guides (DOI: 10.1080/10447318.2025.2604631).
    ...
    modules: [
      {
        ...
        honors: [
          { title: "Published in International Journal of Human–Computer Interaction (SSCI): 'From Content to Conversation: Explaining Adoption of On-Device Generative AI Tour Guides' (DOI: https://doi.org/10.1080/10447318.2025.2604631)", year: "December, 2025" },
